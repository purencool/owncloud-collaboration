...
<div id="app-content">
	<div id="content-header" >
	  <h1 id="title"><?php p($l->t('Project Details')); ?></h1>
	</div>
	<div id="content-body" >
	  <table id="details">
			<tr>
			  <td><?php p($l->t('Project Title')); ?></td>
				<td><?php p($_['project_details']['title']); ?></td>
		  </tr>

		  <tr>
			  <td><?php p($l->t('Description')); ?></td>
			  <td><?php p($_['project_details']['description']); ?></td>
		  </tr>

		  <tr>
		  	<td><?php p($l->t('Deadline')); ?></td>
			  <td>
			       <?php
